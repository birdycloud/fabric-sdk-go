...
[![Release](https://img.shields.io/github/release/birdycloud/fabric-sdk-go.svg?style=flat-square)](https://github.com/birdycloud/fabric-sdk-go/releases/latest)
[![License](https://img.shields.io/badge/License-Apache%202.0-blue.svg)](https://raw.githubusercontent.com/birdycloud/fabric-sdk-go/main/LICENSE)
[![GoDoc](https://godoc.org/github.com/birdycloud/fabric-sdk-go?status.svg)](https://godoc.org/github.com/birdycloud/fabric-sdk-go)

[![Build Status](https://dev.azure.com/birdycloud/fabric-sdk-go/_apis/build/status/hyperledger.fabric-sdk-go?branchName=main)](https://dev.azure.com/birdycloud/fabric-sdk-go/_build/latest?definitionId=19&branchName=main)
[![codecov](https://codecov.io/gh/birdycloud/fabric-sdk-go/branch/main/graph/badge.svg)](https://codecov.io/gh/birdycloud/fabric-sdk-go)
[![Go Report Card](https://goreportcard.com/badge/github.com/birdycloud/fabric-sdk-go)](https://goreportcard.com/report/github.com/birdycloud/fabric-sdk-go)
...
```bash
go get github.com/birdycloud/fabric-sdk-go
```
...
SDK documentation can be viewed at [GoDoc](https://godoc.org/github.com/birdycloud/fabric-sdk-go).
...
```bash
git clone https://github.com/birdycloud/fabric-sdk-go.git
```
